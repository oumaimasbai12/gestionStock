            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('exits.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="customer_id" class="block font-medium text-sm text-gray-700">{{ __('Cliente') }}</label>
                            <select name="customer_id" id="customer_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-400 focus:border-blue-400">
                                <option value="">{{ __('Selecciona un Cliente (optional)') }}</option>
