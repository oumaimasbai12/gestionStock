                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-1">
                                    <a href="{{ route('exits.restore', $exit->id) }}" class="inline-flex items-center px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600">
                                        <!-- Restore icon -->
                                    ...
                                    <form action="{{ route('exits.forceDelete', $exit->id) }}" method="POST" class="inline" onsubmit="return confirm('{{ __('Are you sure you want to permanently delete this exit?') }}')">
                                        @csrf
                                        @method('DELETE')
