    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('users.trash') }}" class="inline-flex items-center bg-sage/10 hover:bg-ink/5 text-accent border border-ink/20 px-4 py-2 rounded-md text-sm font-medium transition space-x-1.5">
                ...
                <a href="{{ route('users.create') }}" class="inline-flex items-center btn-primary text-cream px-4 py-2 rounded-md text-sm font-semibold transition space-x-1.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm text-ink/80 divide-y divide-ink/10">
                            ...
                            <tr class="hover:bg-accent/5 transition duration-150">
                                <td class="py-4 px-6 font-semibold text-ink">{{ $user->name }}</td>
                                <td class="py-4 px-6 text-ink/70">{{ $user->email }}</td>
                                <td class="py-4 px-6">
                                ...
                                <td class="py-4 px-6 text-right">
                                    <div class="inline-flex items-center space-x-2">
                                        <a href="{{ route('users.show', $user) }}" class="inline-flex items-center bg-sage/10 hover:bg-ink/5 text-ink border border-ink/20 px-3 py-1.5 rounded-md text-xs font-semibold transition space-x-1" title="Voir">
                                        ...
                                        <a href="{{ route('users.edit', $user) }}" class="inline-flex items-center bg-accent/15 hover:bg-accent/20 text-ink border border-accent/30 px-3 py-1.5 rounded-md text-xs font-semibold transition space-x-1" title="Modifier">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
