                ...
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="document_id" id="document_id" value="{{ old('document_id') }}" required class="mt-1 app-input">
                            @error('document_id')
                                <span class="text-accent text-xs mt-1 block font-medium">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="ice" id="ice" value="{{ old('ice') }}" class="mt-1 app-input">
                            @error('ice')
                                <span class="text-accent text-xs mt-1 block font-medium">{{ $message }}</span>
                            @enderror
                        </div>
