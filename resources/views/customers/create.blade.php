                ...
                <div class="p-6">
                    <form action="{{ route('customers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="document_id" id="document_id" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-400 focus:border-gray-400">
                            @error('document_id')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-400 focus:border-gray-400">
                            @error('email')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="address" id="address" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-400 focus:border-gray-400">
                            @error('address')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" id="phone" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-400 focus:border-gray-400">
                            @error('phone')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
